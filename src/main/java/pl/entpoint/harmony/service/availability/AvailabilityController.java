...
import pl.entpoint.harmony.entity.pojo.controller.AvailabilityCreation;
...
public class AvailabilityController {
    ...
    public ResponseEntity<String> create(@RequestBody AvailabilityCreation creation) {
        availabilityService.create(creation.getDate(), creation.getDaysOff());
